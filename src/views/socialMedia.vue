...
<template>
    ...
    <div class="flex flex-col h-screen bg-center bg-cover bg-no-repeat">
        <div class="grid place-items-center mx-auto p-20 sm:my-auto bg-111827 rounded-3xl space-y-10 border border-00E7C7">
            <h1 class="text-5xl font-semibold text-blue-500">Mis redes sociales</h1>
